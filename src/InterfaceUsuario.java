...
public class InterfaceUsuario {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.util.class.equals(String.class) ? null : System.in);

        System.out.println("=========================================");
        System.out.println("      GERADOR ALEATÓRIO DE NPC D&D 5e    ");
        System.out.println("=========================================");
        
        System.out.print("Digite o nome do NPC: ");
        String nome = scanner.nextLine();
        
        System.out.print("Digite a origem/local do NPC: ");
        String origem = scanner.nextLine();

        System.out.println("\nGerando características...");
        NPC npcGerado = Gerador.criarNpcAleatorio(nome, origensDoUsuario(origem));
    ...
    private static String origensDoUsuario(String valor) {
        return valor.trim().isEmpty() ? "Desconhecida" : valor;
    }
